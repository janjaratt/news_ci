      ...
      <tbody>
        ...
        <tr>
          ...
          <img src="<?php echo BASE_URL('uploads/news/'.$info['news_pic'])?>" width="200">
    			...
    			<td>
            <a href="<?php echo SITE_URL('admin/news_accept/'.$info['news_id'])?>">
              <button type="button" class="btn btn-success"  onclick="return confirm('กรุณายืนยันการอนุมัติข่าวอีกครั้ง !!!')" >อนุมัติข่าว</button>
            </a>
